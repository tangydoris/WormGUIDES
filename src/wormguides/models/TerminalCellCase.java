...
public class TerminalCellCase extends CellCase {
    ...
    private ArrayList<ArrayList<String>> homologues; //homologues[0] will contain L/R homologues, homologues[1] will
    // contain additional symmetries
...
//			}
    ...
    private void findImageURLInHTML(String content) {
        ...
        for (String url : images) {
            ...
            //if funcName ends with number, check if the image has a range of numbers e.g. DA3-7, or if two
    ...
    private String findFunctionInHTML(String content, String URL) {
        ...
        return content + "<br><em>Source: </em><a href=\"#\" name=\"" + URL + "\" onclick=\"handleLink(this)\">" + URL
                + "</a>";
    }
    ...
    private ArrayList<ArrayList<String>> setHomologues() {
        ArrayList<ArrayList<String>> homologues = new ArrayList<>();
        ArrayList<String> leftRightHomologues = new ArrayList<>();
        ArrayList<String> additionalSymmetries = new ArrayList<>();
...
//		String cell = this.funcName;
//		//check for left, right, dorsal, or ventral suffix --> update cell
//		if (lastChar == 'l' || lastChar == 'r' || lastChar == 'd' || lastChar == 'v' || lastChar == 'a' || lastChar ==
// 'p') {
//			//check if multiple suffixes
//			lastChar = funcName.charAt(funcName.length()-2);
//			lastChar = Character.toLowerCase(lastChar);
