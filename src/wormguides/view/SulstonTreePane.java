...
public class SulstonTreePane extends ScrollPane {
    ...
    public SulstonTreePane(
        ...
        plusButton.setStyle("-fx-focus-color: -fx-outer-border; -fx-faint-focus-color: transparent;"
    ...
    private int recursiveDraw(
        ...
        int leftXUse = nameXUseMap.get(cLeft.getValue());
        int rightXUse = nameXUseMap.get(cRite.getValue());
        int leftYUse = nameYStartUseMap.get(cLeft.getValue());
