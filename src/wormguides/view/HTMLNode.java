...
public class HTMLNode {
	...
	private String formatNode(HTMLNode node) {
		...
		if (node.isContainer()) { // e.g. <head>, <div>
			...
			if (!node.getID().equals("")) {
				nodeStr = newLine + "<" + node.getTag() + " id=\"" + node.getID() + "\">" + newLine
						+ node.getInnerHTML() + newLine + "</" + node.getTag() + ">";
			} else {
				nodeStr = newLine + "<" + node.getTag() + ">" + newLine + node.getInnerHTML() + newLine + "</"
						+ node.getTag() + ">";
			}
			...
			nodeStr = newLine + "<" + node.getTag() + " type=\"" + node.getID() + "\">" + newLine + newLine
					+ node.getStyle() + newLine + "</" + node.getTag() + ">";
		} else if (node.isButton()) { // using imgSrc for onlick and innerHTML
										// for button text
			nodeStr = newLine + "<" + node.getTag() + " onclick=\"" + node.getOnclick() + "()\"" + " id=\""
					+ node.getID() + "\">" + node.innerHTML + "</" + node.getTag() + ">";
		} else if (node.isScript()) {
			nodeStr = newLine + "<" + node.getTag() + ">" + newLine + node.getScript() + newLine + "</" + node.getTag()
					+ ">";
		}
	...
	public HTMLNode makeCollapseButtonScript() {
		...
		String script = functionName + newLine + "    if (document.getElementById('" + this.getID()
				+ "').innerHTML == \"+\") {" + newLine + "        document.getElementById('" + this.getID()
				+ "').innerHTML = \"-\";" + newLine + "        document.getElementById('" + divToCollapseID
				+ "').style.height = '20%'; " + newLine + "        document.getElementById('" + divToCollapseID
				+ "').style.visibility = 'visible'; " + newLine + "    } else {" + newLine
				+ "        document.getElementById('" + this.getID() + "').innerHTML = \"+\";" + newLine
				+ "        document.getElementById(\"" + divToCollapseID + "\").style.height = '0px'; " + newLine
				+ "        document.getElementById('" + divToCollapseID + "').style.visibility = 'hidden'; " + newLine
				+ "    }" + newLine + "}";
	...
	public HTMLNode makeHomologuesCollapseButtonScript() {
		...
		String script = "function homologuesCollapse() {" + newLine
				+ "if (document.getElementById('homologuesCollapseButton').innerHTML == \"+\") {" + newLine
				+ "document.getElementById('homologuesCollapseButton').innerHTML = \"-\";" + newLine
				+ "document.getElementById('homologues').style.height = '20%';" + newLine
				+ "document.getElementById('homologues').style.visibility = 'visible'; " + newLine
				+ "document.getElementById('homologuesLR').style.height = '20%';" + newLine
				+ "document.getElementById('homologuesLR').style.visibility = 'visible';" + newLine
				+ "document.getElementById('homologuesOther').style.height = '20%';" + newLine
				+ "document.getElementById('homologuesOther').style.visibility = 'visible';" + newLine + "} else {"
				+ newLine + "document.getElementById('homologuesCollapseButton').innerHTML = \"+\";" + newLine
				+ "document.getElementById('homologues').style.height = '0px'; " + newLine
				+ "document.getElementById('homologues').style.visibility = 'hidden';" + newLine
				+ "document.getElementById('homologuesLR').style.height = '0px';" + newLine
				+ "document.getElementById('homologuesLR').style.visibility = 'hidden';" + newLine
				+ "document.getElementById('homologuesOther').style.height = '0px';" + newLine
				+ "document.getElementById('homologuesOther').style.visibility = 'hidden';" + newLine + "}" + newLine
				+ "}";
