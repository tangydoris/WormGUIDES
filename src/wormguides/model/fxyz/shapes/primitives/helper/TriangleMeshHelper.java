...
import wormguides.model.fxyz.utils.FloatCollector;
import wormguides.model.fxyz.utils.NormalMap;
import wormguides.model.fxyz.utils.Palette;
import wormguides.model.fxyz.utils.Palette.ColorPalette;
import wormguides.model.fxyz.utils.Patterns;
...
//        System.out.println("Min: "+min+", max: "+max);  
    ...
    */
    ...
    public int[] updateFacesWithoutTexture(List<Face3> faces){
        return faces.parallelStream().map(f->f.getFace()).flatMapToInt(i->i).toArray();
    }
