...
public class Note {
	...
	public boolean isWithoutScope() {
		...
		if (!tagDisplay.equals(Display.OVERLAY) && attachmentType.equals(Type.CELL) && !isEntitySpecified())
			return true;
	...
	public boolean hasEntityNameError() {
		if (!tagDisplay.equals(Display.OVERLAY) && (attachedToCell() || attachedToStructure()) && cellName.isEmpty())
			return true;
