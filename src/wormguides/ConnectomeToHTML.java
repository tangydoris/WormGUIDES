...
public class ConnectomeToHTML {
	...
	/*
	 * Method that generates a legible summary of the wiring partners given a
	 * query cell in the connectome
	 * 
	 * Used to generate a snippet of HTML for the global connectome HTML file OR
	 * to generate a complete HTML page for a single search cell
	 * 
	 * If using this method to generate an external info page for a single cell,
	 * pass a TRUE bool val to generate a full HTML page
	 */
	public String queryWiringPartnersAsHTMLTable(String queryCell, boolean generateFullHTML) {
		...
		String queryCellTableHeaderRow = HTMLTags.openTableRowHTML + HTMLTags.openTableHeader2SpanHTML + cellTitle
				+ queryCell + HTMLTags.closeTableHeaderHTML + HTMLTags.closeTableRowHTML;
		...
		String table = HTMLTags.openTableTagHTML + queryCellTableHeaderRow + presynapticPartnersTableRow
				+ postsynapticPartnersTableRow + electricalPartnersTableRow + neuromuscularPartnersTableRow
				+ HTMLTags.closeTableTagHTML;
